...
class OvenTMS38(object):

    def __init__(self, rm, address='GPIB1::15::INSTR'):
        # pass
        self.inst = rm.open_resource(address, read_termination='\r\n', write_termination='\r\n')
        # self.inst.timeout = 6000

    def __repr__(self):
        # return 'Oven TMS38 on adddr 15'
        return "{} on ".format(__class__.__name__)
...
oven = OvenTMS38(rm, 'GPIB1::15::INSTR')
